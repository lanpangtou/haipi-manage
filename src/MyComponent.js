...
MyComponent.install = function (Vue) {
  Vue.component("vTree", () => import('./view/components/tree/Tree'));
  Vue.component("vCascader", () => import('./view/components/cascader/Cascader'));
  Vue.component("vUpload", () => import('./view/components/form/Upload'));
  Vue.component("vEditor", () => import('./view/components/form/Editor'));
